...
public class Example15 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log($"doubleValue: {doubleValue}"); // 3.1415926535897
        Debug.Log($"floatValue: {floatValue}"); // 3.141593
        ...
        Debug.Log($"stringValue3: {stringValue3}"); // 10


        // 5. 문자열을 숫자로

        // 5-1. Parse() 메소드를 이용 // 분석하다()
        ...
        string stringValue6 = "4354하하하하호호"; //"하하하하호호" 가 있어서 int 숫자로 변환 X.
        int intValue6;
